		...
		<br><br><br><br>
		<div class="container">
			<h1 class=".text-secondary text-center"><?php echo $detail_article[0]->title; ?></h1>
			<br>
				<div class="col-md-12">
					<img src="<?php echo base_url('upload/img_article/'.$detail_article[0]->img); ?>" class="mx-auto d-block" alt="" width="75%" height="75%">
					<br>
					<div class="text-secondary">
						<p class="text-dark"><?php echo $detail_article[0]->article; ?></p>
				</div>
			</div>	
		</div>
			...
			?>	
					<div class="col-sm-4 mt-5">
						<div class="row col-md-12 ">
							<div>
								<a href="<?php echo site_url('ctrl/article/'.$ra->slug); ?>">
								<img class="article_img_home" src="<?php echo base_url('upload/img_article/'.$ra->img); ?>" width="75%">
