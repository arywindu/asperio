            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-6 col-sm-4 mt-3">
                        <button class="btn btn-info float-right"><i class="fa fa-plus-circle"></i> Tambah pengguna</button>
                    </div>
                </div>
                <!-- ============================================================== -->
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="text-center">
                                    <h2 class="font-light m-b-0"><i class="fa fa-grav m-r-10 text-info"></i>1402</h2>
                                    <span class="text-muted">Pengguna yang terdaftar</span>
                                </div>
                                <!--
