<div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Jumlah webinar</h4>
                                <div class="text-center">
                                <?php 
                                if(empty($webinar)){
                                ?>
                                    <h2 class="font-light m-b-0"><i class="fa fa-file-text-o text-info"></i> 0</h2>
                                    <span class="text-muted">webinar yang tersimpan</span>
                                <?php 
                                }
                                else
                                {                                
                                ?>
                                    <h2 class="font-light m-b-0"><i class="fa fa-file-text-o text-info"></i> <?php echo COUNT($webinar); ?></h2>
                                    <span class="text-muted">webinar yang tersimpan</span>
                                <?php 
                                }
                                ?>
                ...
                <!--  Looping script pop up modal delete webinar -->
                <?php 
                foreach($webinar as $ar)
                {
                ?>
                    ...
                    <div class="modal-dialog">   
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title">Konfirmasi hapus webinar</h4>
                          <button type="button" class="close" data-dismiss="modal">&times;</button>                          
                        </div>
                        <div class="modal-body text-center">
                            <p class="text-center">Apakah anda yakin ingin menghapus webinar <b>"<?php echo $ar->title; ?>"</b>?</p>
